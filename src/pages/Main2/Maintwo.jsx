                ...
                <div className='mainse'>
                    ...
                    <div className='valuserbox'>
                        <div className='valfirstuser'>
                            <img src="/images/tier_val/radient.webp" className='tier_diamond' alt=''></img>
                            <img src="/images/yumi.png" className='firstimage' alt=''></img>
                            <h2>나는 조용제</h2>
                        </div>
                        <div className='valseconduser'>
                            <img src="/images/tier_val/radient.webp" className='tier_grand' alt=''></img>
                            <img src="/images/yumi.png" className='secondimage' alt=''></img>
                            <h2>d1spel</h2>
                        </div>
                        <div className='valthirduser'>
                            <img src="/images/tier_val/radient.webp" className='tier_challenger' alt=''></img>
                            <img src="/images/profile.png" className='thirdimage' alt=''></img>
                            <h2>뱃살은 애굣살</h2>
                        </div>
                        <div className='valfourthuser'>
                            <img src="/images/tier_val/radient.webp" className='tier_master' alt=''></img>
                            <img src="/images/yumi.png" className='fourthimage' alt=''></img>
                            <h2>나는 조용제</h2>
                        </div>
                        <div className='valfifthuser'>
                            <img src="/images/tier_val/radient.webp" className='tier_platinum' alt=''></img>
